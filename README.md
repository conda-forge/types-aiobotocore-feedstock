About types-aiobotocore-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-aiobotocore-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-aiobotocore-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-aiobotocore
# for installing globally
pixi global install types-aiobotocore
```
...
It is possible to list all of the versions of `types-aiobotocore` available on your platform:
...
```
pixi search types-aiobotocore --channel conda-forge
```
